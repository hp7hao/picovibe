...
#include ./basmodcn.texts.zhcn.lua
i18n.lang="zhcn"
...
function game_over:draw()
    ...
    if self.anim_t>=10 then
        ...
        _p("game over",self.x-16,self.cam_y+self.y-10,2)
        ...
        if self.highscore then
            ...
            _p("new",self.x-6,self.cam_y+self.y)
            --print("highscore",self.x-18,self.cam_y+self.y+8)
            _p("highscore",self.x-18,self.cam_y+self.y+8)
            print(self.score,64-flr((#tostr(self.score)*4)/2),self.cam_y+self.y+18)
        else
            --print("score",self.x-9,self.cam_y+self.y+7)
            _p("score",self.x-9,self.cam_y+self.y+5)
...
function higscore:draw()
    ...
    _p("best",self.x-4,self.y-1,15)
    print(self.highscore,self.x+25,self.y+1,15)
end
