...
version 42
__lua__
-- i18n runtime (generated by pico8ide)
-- locale: zh, 55 unique glyphs
_gd=""
_gw={4,2,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,6,4,4,4,4,4,4,4,4,2,4,4,8,8,8,8,8,8,3,4,4,4,8,8,3,8,8}
_td={
 ["0"]={w=4,s="\128"},
 ["1"]={w=4,s="\128"},
 ["2"]={w=2,s="\129"},
 ...
 ["p"]={w=8,s="\149"},
 ["q"]={w=8,s="\150"},
 ["deaths"]={w=16,s="\151\152"},
 ["level"]={w=16,s="\153\154"},
 ["meter"]={w=8,s="\155"},
 ["matt_thorson"]={w=48,s="\156\157\158\158\129\158\159\160\161\162\160\163"},
 ["noel_berry"]={w=36,s="\163\160\164\165\129\166\164\161\161\167"},
 ["old_site"]={w=16,s="\168\169"},
 ["summit"]={w=16,s="\170\171"},
 ["score"]={w=19,s="\172\173\174"},
 ["translator"]={w=47,s="\159\175\176\159\157\160\177\178\179\180"},
 ["start"]={w=16,s="\181\182"},
}
...
function _txi()
 ...
 poke(0x5601,8)
 poke(0x5602,8)
 for i=1,#_gd do poke(0x59ff+i,ord(_gd,i)) end
end
...
function tx(k,x,y,c)
 ...
 for i=1,#d.s do
  local ch=ord(d.s,i)
  if ch==10 then cx=x y+=10
  else
   print("\014"..chr(ch),cx,y,c)
   cx+=_gw[ch-127]
  end
 end
end
		...
		if this.check(player,4,0) then
			...
			for i=1,this.index do
				if sub(this.text,i,i)~="#" then
					...
					if txt=="0" then
						tx("0",this.off.x,this.off.y,0)
					elseif txt=="1" then
						tx("1",this.off.x,this.off.y,0)
					elseif txt=="2" then
						tx("2",this.off.x,this.off.y,0)
					elseif txt=="3" then
						tx("3",this.off.x,this.off.y,0)
					elseif txt=="4" then
						tx("4",this.off.x,this.off.y,0)
					elseif txt=="5" then
						tx("5",this.off.x,this.off.y,0)
					elseif txt=="6" then
						tx("6",this.off.x,this.off.y,0)
					elseif txt=="7" then
						tx("7",this.off.x,this.off.y,0)
					elseif txt=="8" then
						tx("8",this.off.x,this.off.y,0)
					elseif txt=="9" then
						tx("9",this.off.x,this.off.y,0)
					elseif txt=="a" then
						tx("a",this.off.x,this.off.y,0)
					elseif txt=="b" then
						tx("b",this.off.x,this.off.y,0)
					elseif txt=="c" then
						tx("c",this.off.x,this.off.y,0)
					elseif txt=="d" then
						tx("d",this.off.x,this.off.y,0)
					elseif txt=="e" then
						tx("e",this.off.x,this.off.y,0)
					elseif txt=="f" then
						tx("f",this.off.x,this.off.y,0)
					elseif txt=="g" then
						tx("g",this.off.x,this.off.y,0)
					elseif txt=="h" then
						tx("h",this.off.x,this.off.y,0)
					elseif txt=="i" then
						tx("i",this.off.x,this.off.y,0)
					elseif txt=="j" then
						tx("j",this.off.x,this.off.y,0)
					elseif txt=="k" then
						tx("k",this.off.x,this.off.y,0)
					elseif txt=="l" then
						tx("l",this.off.x,this.off.y,0)
					elseif txt=="m" then
						tx("m",this.off.x,this.off.y,0)
					elseif txt=="n" then
						tx("n",this.off.x,this.off.y,0)
					elseif txt=="o" then
						tx("o",this.off.x,this.off.y,0)
					elseif txt=="p" then
						tx("p",this.off.x,this.off.y,0)
					elseif txt=="q" then
						tx("q",this.off.x,this.off.y,0)
					end
					this.off.x+=10
				else
					this.off.x=4
	...
	draw=function(this)
		...
		elseif this.delay<0 then
			...
			elseif level_index()==30 then
				...
				tx("meter",52+(level<1000 and 2 or 0)+16,60,7)
			end
			--print("---",86,64-2,13)
...
function _draw()
	...
	if is_title() then
		tx("start",56,78,5)
		tx("matt_thorson",42,86,5)
		tx("noel_berry",46,94,5)
		tx("translator",46,106,5)
	end
